...
def dump_joblib(obj, filename: str):
...
def run_data_prep(raw_data_path: str, dest_path: str, dataset: str = "green"):
    ...
    dump_joblib(dv, os.path.join(dest_path, "dv.pkl"))
    dump_joblib((X_train, y_train), os.path.join(dest_path, "train.pkl"))
    dump_joblib((X_val, y_val), os.path.join(dest_path, "val.pkl"))
    dump_joblib((X_test, y_test), os.path.join(dest_path, "test.pkl"))
